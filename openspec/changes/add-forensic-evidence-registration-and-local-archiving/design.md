...
### Hook de Docker — fora do escopo atual

Por solicitação explícita do usuário, a tarefa 2.5 foi removida do planejamento atual. Sua integração completa deixa de ser requisito desta mudança e dependência da demonstração em 7.2. O histórico técnico e as limitações do contrato observado permanecem em [docs/docker-hook-validation.md](../../../docs/docker-hook-validation.md) e [docs/hook-integration-2026-09-11.md](../../../docs/hook-integration-2026-09-11.md).

Esta retirada é documental: scripts, configurações e fontes de confiança existentes não foram alterados ou desativados. A execução de Docker continua exigindo apresentação do comando concreto e autorização humana `APROVADO: Use o docker.`, vinculada à ação revisada. Outros guardrails e permissões continuam válidos; a retirada da tarefa não autoriza contornar qualquer recusa.
